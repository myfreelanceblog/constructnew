...
<section class="faq-section">
    <div class="container">
        <div class="faq pad">
            <h2 class="faq__title h1 title-color"><?= isset($faq_title) ? $faq_title : 'Ответы на часто задаваемые вопросы' ?></h2>
            ...
            <?php if(isset($faq_btn)): ?>
            <div class="line-btn faq__more">
                <button type="button" class="btn-def" data-modal="order">
