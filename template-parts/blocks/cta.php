<section class="cta-section pad">
    <div class="container">
        <div class="cta">
            <picture>
                <source srcset="assets/img/content/cta-bg-mob.webp" media="(max-width: 568px)">
                <img src="assets/img/content/cta-bg.webp" class="cta-bg" alt="cta" loading="lazy">
            </picture>
            <div class="cta__content">
                ...
                <button class="btn cta__btn pointer btn--white" type="button" aria-label="Подобрать ПК" data-modal="quiz">
                    ...
                    <div class="btn__content">
                        <span>Подобрать ПК</span>
                    </div>
                </button>
            </div>
            <div class="cta__img">
                <img src="assets/img/content/cta.png" alt="cta" loading="lazy">
            </div>
        </div>
    </div>
</section>